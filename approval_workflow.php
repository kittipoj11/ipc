                                        ...
                                        <tr id="{$row['workflow_id']}">
                                            ...
                                            <td align='center'>
                                                <div class='btn-group-sm'>
                                                    <a class='btn btn-warning btn-sm btnEdit' data-bs-toggle='modal'  data-bs-placement='right' title='Edit' data-bs-target='#openModal' iid='{$row['workflow_id']}' style='margin: 0px 5px 5px 5px'>
                                                        <i class='fa-regular fa-pen-to-square'></i>
                                                    </a>
                                                    <a class='btn btn-danger btn-sm btnDelete' data-bs-toggle='modal'  data-bs-placement='right' title='Delete' data-bs-target='#deleteModal' iid='{$row['workflow_id']}' style='margin: 0px 5px 5px 5px'>
        ...
        <div class="modal-content">
          ...
          <form name="frmOpen" id="frmOpen" action="" method="">
            ...
            <div class="modal-body">
              ...
              <div class="row m-3">
                <label for="workflow_name" class="col-sm-6 col-form-label">approval_workflow name</label>
                <div class="col-sm-6">
