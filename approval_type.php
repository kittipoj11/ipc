...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  ...
  <div class="wrapper">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <!-- <div class="card-header">
                               <h3 class="card-title">approval_type</h3>
                           </div> -->
                <!-- /.card-header -->
                                        ...
                                        <tr id="{$row['approval_type_id']}">
                                            ...
                                            <td align='center'>
                                                <div class='btn-group-sm'>
                                                    <a class='btn btn-warning btn-sm btnEdit' data-bs-toggle='modal'  data-bs-placement='right' title='Edit' data-bs-target='#openModal' iid='{$row['approval_type_id']}' style='margin: 0px 5px 5px 5px'>
                                                        <i class='fa-regular fa-pen-to-square'></i>
                                                    </a>
                                                    <a class='btn btn-danger btn-sm btnDelete' data-bs-toggle='modal'  data-bs-placement='right' title='Delete' data-bs-target='#deleteModal' iid='{$row['approval_type_id']}' style='margin: 0px 5px 5px 5px'>
        ...
        <div class="modal-content">
          ...
          <form name="frmOpen" id="frmOpen" action="" method="">
            ...
            <div class="modal-body">
              <div class="row m-3">
                <label for="approval_type_id" class="col-sm-6 col-form-label">#</label>
                <div class="col-sm-6">
                  <!-- <input type="hidden" class="approval_type_id" name="approval_type_id"> -->
                  <input type="input" class="form-control form-control-sm fst-italic approval_type_id" id="approval_type_id" readonly name="approval_type_id">
                </div>
              </div>

              <div class="row m-3">
                <label for="approval_type_name" class="col-sm-6 col-form-label">Name</label>
                <div class="col-sm-6">
                  <input type="input" class="form-control form-control-sm" name="approval_type_name" id="approval_type_name">
                </div>
              </div>
            </div>
    ...
    <!-- My JavaScript  -->
    <script src="javascript/approval_type.js"></script>