...
class Po extends Connection
{
    ...
    public function insertData($getData)
    {
        ...
        try {
            ...
            $workflow_id=1;
            $sql = <<<EOD
                        SELECT `workflow_step_id`, `workflow_id`, `approved_level`, `approver_id`, `action_type`
                        FROM `workflow_steps`
