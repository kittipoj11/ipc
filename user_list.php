    ...
    <div class="content-wrapper">
      ...
      <section class="container-fluid content-header">
        <div class="col-sm-6 d-flex">
          <h6 class="m-1 fw-bold text-uppercase">User</h6>
        </div>
        <!-- /.container-fluid -->
      </section>
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header d-flex">
                  <h6 class="m-1 fw-bold">All User</h6>
                  <a href="user_form.php?action=create" class="btn btn-success btn-sm btnNew" title="New" style="margin: 0px 5px 5px 5px;">
                ...
                <div class="card-body p-0" id="card-body">
                  <table id="tableMain" class="table table-bordered table-striped table-sm">
                    <thead>
                      <tr>
                        <th class="text-center p-1" style="width: 150px;">User Code</th>
