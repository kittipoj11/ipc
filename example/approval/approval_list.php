...
require_once 'config.php';
    // สำหรับแสดงรายการงานที่รอการอนุมัติสำหรับผู้ใช้ที่ล็อกอิน
    // สมมติว่ามีการล็อกอินผู้ใช้แล้ว และมี $_SESSION['user_id']
    // ในตัวอย่างนี้เราจะกำหนดให้ผู้ใช้เป็น 'approver1' เพื่อทดสอบ
    $_SESSION['user_id'] = 2; // ID ของผู้ใช้ 'approver1' จากตาราง users
