                                        ...
                                        <tr id="{$row['supplier_id']}">
                                            ...
                                            <td align='center'>
                                                <div class='btn-group-sm'>
                                                    <a class='btn btn-warning btn-sm btnEdit' data-bs-toggle='modal'  data-bs-placement='right' title='Edit' data-bs-target='#openModal' iid='{$row['supplier_id']}' style='margin: 0px 5px 5px 5px'>
                                                        <i class='fa-regular fa-pen-to-square'></i>
                                                    </a>
                                                    <a class='btn btn-danger btn-sm btnDelete' data-bs-toggle='modal'  data-bs-placement='right' title='Delete' data-bs-target='#deleteModal' iid='{$row['supplier_id']}' style='margin: 0px 5px 5px 5px'>
        ...
        <div class="modal-content">
          ...
          <form name="frmOpen" id="frmOpen" action="" method="">
            ...
            <div class="modal-body">
              <div class="row m-3">
                <label for="supplier_id" class="col-sm-6 col-form-label">#</label>
                <div class="col-sm-6">
                  <!-- <input type="hidden" class="supplier_id" name="supplier_id"> -->
                  <input type="input" class="form-control form-control-sm fst-italic supplier_id" id="supplier_id" readonly name="supplier_id">
                </div>
              </div>

              <div class="row m-3">
                <label for="supplier_name" class="col-sm-6 col-form-label">supplier name</label>
                <div class="col-sm-6">
                  <input type="input" class="form-control form-control-sm" name="supplier_name" id="supplier_name">
                </div>
              </div>
            </div>
