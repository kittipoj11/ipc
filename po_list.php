...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  ...
  <div class="wrapper">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header d-flex">
                  ...
                  <a href="po_form.php?action=create" class="btn btn-success btn-sm btnNew" title="New" style="margin: 0px 5px 5px 5px;">
                  ...
                  <table class="table table-bordered justify-content-center text-center" id="tablePeriod">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center p-1" width="15%">ปริมาณงานตามแผน(%)</th>
    ...
    <!-- My JavaScript  -->
    <script src="javascript/po_list.js"></script>