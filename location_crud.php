...
if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'create') {
    ...
    $result=$location->update($_REQUEST['location_id'],$_REQUEST);
    // 4. กำหนด Content-Type เป็น application/json
    header('Content-Type: application/json');
    ...
    $result=$location->delete($_REQUEST['location_id']);
    // 4. กำหนด Content-Type เป็น application/json
    header('Content-Type: application/json');
    ...
    $rs = $location->getById($_REQUEST['location_id']);
    // 4. กำหนด Content-Type เป็น application/json
    header('Content-Type: application/json');
