...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  ...
  <div class="wrapper">
                      ...
                      <div class="col-9">
                        <div class="row m-1">
                          <div class="col-12 input-group input-group-sm">
                            ...
                            <input type="number" step="0.01" class="col-3 form-control" name="interim_payment" id="interim_payment" readonly value="<?= $rsInspectionPeriod['interim_payment'] ?>">
                    ...
                    <div class="row m-1 mb-3">
                      ...
                      <div class="col-4">
                        <div class="row-1 input-group input-group-sm">
                          ...
                          <input type="number" step="0.01" class="col-3 form-control" name="interim_payment" id="interim_payment" readonly value="<?= $rsInspectionPeriod['interim_payment'] ?>">
                          <input type="number" step="0.01" class="form-control " name="workload_actual_completed_percent" id="workload_actual_completed_percent" readonly value="<?php echo isset($rsInspectionPeriod['workload_actual_completed_percent']) ? htmlspecialchars($rsInspectionPeriod['workload_actual_completed_percent']) : ''; ?>">
                        ...
                        <tbody id="tbody-order">
                          <?php foreach ($rsInspectionPeriodDetail as $row) { ?>
                            <tr class="firstTr">
                              ...
                              <td class="input-group-sm p-0"><input type="text" name="details[]" class="form-control detail" value="<?php echo isset($row['details']) ? htmlspecialchars($row['details']) : ''; ?>" readonly>
                              </td>
                              <td class="input-group-sm p-0"><input type="text" name="remarks[]" class="form-control remark" value="<?php echo isset($row['remark']) ? htmlspecialchars($row['remark']) : ''; ?>" readonly>
                              </td>
                              <td class="input-group-sm p-0">
                                <input type="text" name="cruds[]" class="form-control crud" value="s" readonly>
                              </td>
                    ...
                    <div class="card-body">
                      <div class="row m-1 mb-3">
                        <div class="col-8 input-group input-group-sm">
                          ...
                          <select class="form-select form-control" name="plan_status_id" id="plan_status_id" disabled>
                      ...
                      <div class="form-floating">
                        <textarea name="remark" class="form-control" id="floatingTextarea" placeholder="Leave a comment here" rows="4" style="min-height: 4em;height: auto;" disabled><?php echo isset($rsInspectionPeriod['remark']) ? trim(htmlspecialchars($rsInspectionPeriod['remark'])) : ''; ?></textarea>
    ...
    <!-- My JavaScript  -->
    <script src="javascript/inspection_action.js"></script>