        ...
        <div class="modal-content">
          ...
          <form name="frmOpen" id="frmOpen" action="" method="">
            ...
            <div class="modal-body">
              <div class="row m-3">
                <label for="role_id" class="col-sm-6 col-form-label">#</label>
                <div class="col-sm-6">
                  <!-- <input type="hidden" class="role_id" name="role_id"> -->
                  <input type="input" class="form-control form-control-sm fst-italic role_id" id="role_id" readonly name="role_id">
                </div>
              </div>

              <div class="row m-3">
                <label for="role_name" class="col-sm-6 col-form-label">role name</label>
                <div class="col-sm-6">
                  <input type="input" class="form-control form-control-sm" name="role_name" id="role_name">
                </div>
              </div>
            </div>
